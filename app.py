...
# Definir novo modo automaticamente
novo_modo = (
...
# Se o novo modo exigir equipa → pedir equipa
equipa_nova = ""
...
if st.button("🔄 Atualizar inscrição"):
    ...
    enviar_email(
        ...
        f"Previous mode: {modo_atual}\n"
        f"New mode: {novo_modo}\n"
        f"Team: {equipa_nova if equipa_nova else '—'}"
    )
